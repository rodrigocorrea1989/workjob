...
if( ! class_exists('acf_field_post_date') ) :

class acf_field_post_date extends acf_field_date_and_time_picker {
	...
	*/
	...
	function initialize() {
		...
		// vars
		$this->name = 'post_date';
		$this->label = __("Published On",'acf');
        ...
        add_filter( 'acf/load_field/type=date_time_picker',  [ $this, 'load_post_date_field'] );
...
// initialize
acf_register_field_type( 'acf_field_post_date' );
