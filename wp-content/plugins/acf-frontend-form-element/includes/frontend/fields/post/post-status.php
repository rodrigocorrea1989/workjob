...
class acf_field_post_status extends acf_field{
    ...
    function initialize(){
        ...
        $this->label = __('Post Status', ACFF_NS);
    ...
    function get_post_status_choices( $posts_statuses = array() ){
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            'label'         => __( 'Statuses to choose from',ACFF_NS ),
            'instructions'  => '',
            'type'          => 'select',
            'name'          => 'post_status',
            ...
            'ui'            => 1,
            'allow_null'    => 1,
            'placeholder'   => __( "All statuses will show", ACFF_NS ),
        ));

        acf_render_field_setting($field, array(
            'label'         => __( 'Default',ACFF_NS ),
            'instructions'  => '',
            'type'          => 'select',
            'name'          => 'default_value',
            'choices'       => $this->get_post_status_choices(),
            'ui'            => 0,
            'allow_null'    => 0,
            'placeholder'   => __( "Any post status", ACFF_NS ),
        ));
    ...
    function prepare_field($field){
        ...
        // Choices
        $field['choices'] = $this->get_post_status_choices( $field['post_status'] );
